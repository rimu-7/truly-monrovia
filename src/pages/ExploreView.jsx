    ...
    return (
        <div className="max-w-7xl min-h-screen mx-auto">
            ...
            <article className="px-4 sm:px-6 lg:px-8 py-8">
                {/* Image Carousel */}
                <div className="relative mb-10 rounded-xl overflow-hidden shadow-lg flex justify-center items-center">
                    {postImages.length > 0 ? (
                        <>
                                ...
                                <div className="absolute bottom-4 left-0 right-0 flex justify-center gap-2">
                                    {postImages.map((_, index) => (
                                        <button
                                            ...
                                            className={`w-3 h-3 rounded-full transition-all ${index === activeImageIndex ? 'bg-white' : 'bg-white/50'}`}
