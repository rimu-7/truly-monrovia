...
const About = () => {
  ...
  return (
    <div className="bg-white text-black min-h-screen mx-auto py-12 px-4 sm:px-6 lg:px-8">
      <div className=" ">
            ...
            <div className="flex flex-wrap justify-center gap-4 sm:gap-6 xl:gap-8 mt-6">
              ...
              >
                <Link to="https://www.tiktok.com">
                  <FaTiktok className="text-4xl sm:text-5xl bg-black text-white p-3 rounded-full   hover:scale-110" />
                </Link>
              </motion.div>
              ...
              >
                <Link to="https://twitter.com">
                  <FaTwitter className="text-4xl sm:text-5xl p-3 text-white rounded-full bg-blue-500 hover:bg-blue-600 hover:scale-110" />
                </Link>
              </motion.div>
              ...
              >
                <Link to="https://www.youtube.com">
                  <FaYoutube className="text-4xl sm:text-5xl text-white p-3 rounded-full bg-red-600 hover:bg-red-700 hover:scale-110" />
                </Link>
              </motion.div>
            </div>
          </div>
