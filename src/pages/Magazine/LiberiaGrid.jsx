  ...
  const gridItems = [
    {
      ...
      description: "Exploring a nation on the rise as Liberia embraces its future while honoring its heritage.",
      category: "Spotlight",
      image: "https://images.pexels.com/photos/1251171/pexels-photo-1251171.jpeg",
      cols: "lg:col-span-2",
    ...
    },
    {
      id: 2,
      title: "",
      image: "https://images.pexels.com/photos/2218239/pexels-photo-2218239.jpeg",
      cols: "",
      buttonText: "Culture"
    },
    {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="grid grid-cols-2 gap-6">
          {gridItems.slice(1).map((item) => (
            <div key={item.id} className="group relative h-full min-h-[200px] rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-500">
              <img
                src={item.image}
                alt={item.title}
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/30 to-transparent flex items-end p-6">
                <button className="px-6 py-2 bg-white/90 hover:bg-white text-gray-900 font-medium rounded-full transition-all duration-300 hover:translate-y-1">
                  {item.buttonText}
                </button>
              </div>
