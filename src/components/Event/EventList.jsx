...
import { Edit, Trash2, X, Check, Loader2, Calendar, MapPin } from "lucide-react";
                ...
                <div className="space-y-6">
                    {posts.length > 0 ? (
                        posts.map((post) => (
                            <div
                                key={post.id}
                                className="bg-gray-800 rounded-xl overflow-hidden shadow-lg border border-gray-700 transition-all hover:border-[#FFD700]"
                            >
                                        ...
                                        {editingId === post.id ? (
                                            <div className="space-y-4">
                                                <input
                                                    ...
                                                    className="w-full px-4 py-2 bg-gray-700 rounded-lg text-gray-200 focus:outline-none focus:ring-2 focus:ring-[#FFD700] text-lg font-bold"
                                                ...
                                                <textarea
                                                    ...
                                                    rows={4}
                                                    className="w-full px-4 py-2 bg-gray-700 rounded-lg text-gray-200 focus:outline-none focus:ring-2 focus:ring-[#FFD700]"
                                                ...
                                                {editingId === post.id ? (
                                                    <>
                                                        ...
                                                        <button
                                                            ...
                                                            disabled={isUpdating}
                                                            className="px-3 py-1 bg-[#FFD700] text-gray-900 rounded-lg hover:bg-[#e6c200] transition flex items-center gap-1 disabled:opacity-50"
                                                        >
                                                            {isUpdating ? (
